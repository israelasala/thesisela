---
title: "ANOVA and Kruskal-Wallis Test for GSI and PCI with Post-Hoc Analysis"
...
## Post-Hoc Analysis: Tukey's HSD for ANOVA
...
## Post-Hoc Analysis: Dunn’s Test for Kruskal-Wallis

```{r}
dunnTest(GSI ~ Size_Class, data = cots_data, method = "bonferroni")
dunnTest(PCI ~ Size_Class, data = cots_data, method = "bonferroni")
```
